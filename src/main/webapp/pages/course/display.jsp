...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800"><i class="fas fa-book fa-2x text-black-50"></i> Display Courses</h1>
                                ...
                                <c:if test="${fn:contains(auth.getCurrentUser().authority, 'ROLE_ADMINISTRATOR')}">
                                    <td>
                                        <a class="btn btn-sm btn-info text-white"
                                           href="${pageContext.request.contextPath}/course/edit/${course.id}"><i
