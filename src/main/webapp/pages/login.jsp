                            ...
                            <div class="p-5">
                                ...
                                <form class="user" action="${pageContext.request.contextPath}/login" method="post"
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="loginUsername"
                                               placeholder="Enter Username..." name="username" autofocus required>
                                    </div>
                                    <div class="form-group">
                                        <input type="password" class="form-control form-control-user"
                                               id="loginPassword" placeholder="Password" name="password" required>
                                    </div>
                                    <div class="form-group">
                                ...
                                <hr>
                                <div class="text-center">
                                    <a class="small" href="${cp}/resetPassword">Forgot Password?</a>
                                </div>
                            </div>
                        </div>
                    </div>
