...
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800"><i class="fas fa-calendar-day fa-2x text-black-50"></i> Edit Room Schedule</h1>
    ...
    <div class="col-lg-12">
        <div class="card shadow mb-4">
            ...
            <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                <h6 class="m-0 font-weight-bold text-primary">Edit Room Schedule Form</h6>
            </div>
            <!-- Card Body -->
            <div class="card-body">
                <div class="p-5">
                    <form method="post" action="${pageContext.request.contextPath}/room/schedule/edit">

                        <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}"/>
                        <input type="hidden" name="id" value="${roomSchedule.id}"/>
                        <input type="hidden" name="version" value="${roomSchedule.version}"/>
